const info = {
    ...
    explorers: [
        ...
        },
        {
            ...
            tx_page: 'https://staking-explorer.com/transaction.php?chain=sentinel&tx=${txHash}',
            account_page: 'https://staking-explorer.com/account.php?chain=sentinel&addr=${accountAddress}'
        },
        {
            kind: 'Roomit',
