const info = {
    ...
    explorers: [
        ...
        },
        {
            ...
            tx_page: 'https://staking-explorer.com/transaction.php?chain=cryptoorgchain&tx=${txHash}',
            account_page: 'https://staking-explorer.com/account.php?chain=cryptoorgchain&addr=${accountAddress}'
        },
        {
            kind: 'ezstaking',
