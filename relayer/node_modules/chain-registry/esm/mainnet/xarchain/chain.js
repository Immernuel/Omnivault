const info = {
    ...
    codebase: {
        ...
        recommended_version: 'v0.0.4-rc.2',
        compatible_versions: ['v0.0.4-rc.2'],
        consensus: {
            type: 'cometbft',
            version: 'v0.38.15'
        },
        ...
        genesis: {
            genesis_url: 'https://cosmos01-testnet.arcana.network:26650/genesis'
        },
        sdk: {
            type: 'cosmos',
            version: 'v0.50.10',
