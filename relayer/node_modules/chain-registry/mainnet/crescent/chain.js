...
const info = {
    ...
    explorers: [
        ...
        },
        {
            ...
            tx_page: 'https://staking-explorer.com/transaction.php?chain=crescent&tx=${txHash}',
            account_page: 'https://staking-explorer.com/account.php?chain=crescent&addr=${accountAddress}'
        },
        {
            kind: 'atomscan',
