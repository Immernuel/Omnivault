...
const info = {
    ...
    explorers: [
        ...
        },
        {
            ...
            tx_page: 'https://cosmotracker.com/lumera/tx/${txHash}',
            account_page: 'https://cosmotracker.com/lumera/account/${accountAddress}'
        },
        {
            kind: 'AstroStake',
            url: 'https://stake.astrostake.xyz/lumera',
            tx_page: 'https://stake.astrostake.xyz/lumera/tx/${txHash}',
            account_page: 'https://stake.astrostake.xyz/lumera/address/${accountAddress}'
        }
    ],
    images: [{
