...
const info = {
    ...
    explorers: [
        ...
        },
        {
            ...
            tx_page: 'https://staking-explorer.com/transaction.php?chain=stride&tx=${txHash}',
            account_page: 'https://staking-explorer.com/account.php?chain=stride&addr=${accountAddress}'
        },
        {
            kind: 'Stakeflow',
