...
const info = {
    ...
    chain_name: 'xarchaintestnet',
    chain_type: 'cosmos',
    chain_id: 'xardev',
    website: 'https://arcana.network/',
    pretty_name: 'XarChain Ceries Testnet',
    status: 'live',
    network_type: 'testnet',
    bech32_prefix: 'arcana',
    daemon_name: 'xarchaind',
    node_home: '$HOME/.xarchain',
    key_algos: ['secp256k1'],
    slip44: 118,
    fees: {
        fee_tokens: [{
    ...
    codebase: {
        git_repo: 'https://github.com/arcana/xarchain',
        recommended_version: 'v0.0.4-alpha.3',
        compatible_versions: ['v0.0.4-alpha.3'],
        consensus: {
            type: 'cometbft',
            version: 'v0.38.15'
        },
        ...
        genesis: {
            genesis_url: 'https://cosmos01-dev.arcana.network:26650/genesis'
        },
        sdk: {
            type: 'cosmos',
            version: 'v0.50.10',
